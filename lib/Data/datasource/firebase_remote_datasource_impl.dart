...
import 'package:companio_community_chat_firebase/data/model/my_chat_model.dart';
import 'package:companio_community_chat_firebase/data/model/text_message_model.dart';
...
class FirebaseRemoteDataSourceImpl implements FirebaseRemoteDataSource {
  ...
  Stream<List<MyChatEntity>> getMyChat(String uid) {
    ...
    return myChatRef.orderBy('time', descending: true).snapshots().map(
          (querySnap) => querySnap.docs
          .map((doc) => MyChatModel.fromSnapshot(doc))  // Corrected here
          .toList(),
    );
  }
