...
import 'package:companio_community_chat_firebase/Utils/Widget/text_field.dart';
import 'package:companio_community_chat_firebase/View/account/login.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    // },
                    onTap: () {
                      if (name.text.toString().isNotEmpty && number.text.toString().isNotEmpty && password.text.toString().isNotEmpty) {
                        // Call the method with the correct arguments: phoneNumber, name, and state
                        FirebaseService.requestOtp(number.text.toString(), name.text.toString(), _controller);
                      } else {
                        ShowSnackBar("Warning", "Fill data correctly");
                      }
                    },
