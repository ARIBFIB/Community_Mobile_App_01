...
import 'package:companio_community_chat_firebase/presentation/pages/sub_pages/select_contact_page.dart';
import 'package:companio_community_chat_firebase/presentation/pages/sub_pages/single_communication_page.dart';
import 'package:companio_community_chat_firebase/presentation/pages/sub_pages/single_item_chat_user_page.dart';
            ...
            itemBuilder: (_, index) {
              ...
              return InkWell(
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (_) => SingleCommunicationPage(
                        key: Key('chat_${myChat.channelId}'),  // Provide a unique key
                ...
                child: SingleItemChatUserPage(
                  key: Key('chat_item_${myChat.channelId}'),
